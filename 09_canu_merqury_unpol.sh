...
#SBATCH --job-name=merqury_canu_unpol
#SBATCH --mail-user=honghong.fang@students.unibe.ch
#SBATCH --mail-type=fail,begin,end
#SBATCH --output=/data/users/hfang/newassembly/evaluations/output_canu_merqury_unpol_%j.o
#SBATCH --error=/data/users/hfang/newassembly/evaluations/error_canu_merqury_unpol_%j.e
...
${WORKDIR}/assemblies/canu/arabidopsis.contigs.fasta \
canu_unpol
